...
rm -f /u01/app/oracle/buf/datapump/export.log
...
. ${DIR}/copy_scp.sh /ora1/buf/datapump/expdat.dmp /u01/app/oracle/buf/datapump/     
. ${DIR}/copy_scp.sh /ora1/buf/datapump/export.log /u01/app/oracle/buf/datapump/
